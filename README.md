 ...
 * 2.Если признаки имеют одинаковые дисперсии <img src="https://github.com/Karbovskaya/ML0/raw/master/Pictures/gif (2).gif" width="30" >
 * 3.Если признаки некоррелированы, <img src="https://github.com/Karbovskaya/ML0/raw/master/Pictures/gif (1).gif" width="40" >, то линии уровня плотности распределения имеют форму эллипсоидов с центром equation)
