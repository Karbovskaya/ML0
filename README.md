 ...
 * 2.Если признаки имеют одинаковые дисперсии <img src="https://github.com/Karbovskaya/ML0/blob/master/Pictures/gif(2).gif" width="15" >
 * 3.Если признаки некоррелированы, <img src="https://https://github.com/Karbovskaya/ML0/blob/master/Pictures/gif%20(1).gif" width="15" >, то линии уровня плотности распределения имеют форму эллипсоидов с центром equation)
