...
С помощью ортогонального преобразования <img src="https://github.com/Karbovskaya/ML0/raw/master/Pictures/gif (3).gif" width="120" > . - ортогональные собственные векторы матрицы <img src="https://github.com/Karbovskaya/ML0/raw/master/Pictures/gif.gif" width="15" >, можно перейти к третьему случаю.
