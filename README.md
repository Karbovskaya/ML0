...
## Линии уровня
 * 1.Если признаки коррелированы, то матрица <img src="https://github.com/Karbovskaya/ML0/raw/master/pictures/gif.gif" width="300" > не диагональна и линии уровня имеют форму эллипсоидов, оси которых повернуты ( направлены вдоль собственных векторов матрицы equation ) относительно исходной системы координат.
