...
Параметры называется независимыми, если значение одного параметра не влияет на другой.
Метод называется наивным, так как мы предпологаем, что все параметры набора независимы друг от друга - это предположение достаточно наивное. Обычно так не бывает.
Упрощенное уравнение для классификации выглядит так:
<img src="https://github.com/Karbovskaya/ML0/raw/master/Pictures/h_T-iT7wqbc.jpg" width="400" >.
